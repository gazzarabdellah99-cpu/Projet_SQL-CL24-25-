-- =========================================================
-- queries.sql
-- Projet SQL : Premier League 2024/2025
-- =========================================================

-- ---------------------------------------------------------
-- 1. Afficher toutes les saisons
-- ---------------------------------------------------------
SELECT *
FROM seasons;

-- ---------------------------------------------------------
-- 2. Afficher toutes les équipes
-- ---------------------------------------------------------
SELECT *
FROM teams
ORDER BY team_name;
...
-- ---------------------------------------------------------
-- 3. Retrouver tous les matchs d’une équipe
-- Remplacez 'Arsenal' par l’équipe voulue
-- ---------------------------------------------------------
SELECT 
    m.match_id,
    m.match_date,
...
-- ---------------------------------------------------------
-- 4. Consulter les résultats de tous les matchs terminés
-- ---------------------------------------------------------
SELECT 
    m.match_date,
    th.team_name AS home_team,
...
-- ---------------------------------------------------------
-- 5. Consulter les résultats d’une équipe
-- Remplacez 'Liverpool' par l’équipe voulue
-- ---------------------------------------------------------
SELECT 
    m.match_date,
    th.team_name AS home_team,
...
-- ---------------------------------------------------------
-- 6. Identifier les meilleurs buteurs
-- ---------------------------------------------------------
SELECT 
    p.player_name,
    t.team_name,
...
-- ---------------------------------------------------------
-- 7. Top 10 des meilleurs buteurs
-- ---------------------------------------------------------
SELECT 
    p.player_name,
    t.team_name,
...
-- ---------------------------------------------------------
-- 9. Top 10 des meilleurs passeurs décisifs
-- ---------------------------------------------------------
SELECT 
    p.player_name,
    t.team_name,
...
-- ---------------------------------------------------------
-- 10. Équipes qualifiées pour la Champions League
-- ---------------------------------------------------------
SELECT 
    t.team_name
...
-- ---------------------------------------------------------
-- 11. Équipes qualifiées pour l’Europa League
-- ---------------------------------------------------------
SELECT 
    t.team_name
FROM team_season_status tss
...
-- ---------------------------------------------------------
-- 12. Équipes qualifiées pour la Conference League
-- ---------------------------------------------------------
SELECT 
    t.team_name
FROM team_season_status tss
...
-- ---------------------------------------------------------
-- 14. Statut final complet de toutes les équipes
-- ---------------------------------------------------------
SELECT 
    t.team_name,
...
-- ---------------------------------------------------------
-- 15. Nombre de matchs joués par équipe
-- ---------------------------------------------------------
SELECT 
    t.team_name,
...
-- ---------------------------------------------------------
-- 16. Nombre total de buts marqués par équipe
-- ---------------------------------------------------------
SELECT 
    t.team_name,
    SUM(
